-- Share-A-Ride Database Seed Data for Apache Derby
...
-- Note: Derby uses different syntax for auto-increment
-- Tables will auto-generate IDs starting after the highest inserted value